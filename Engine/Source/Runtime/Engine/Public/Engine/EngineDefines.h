...
#define HE_MAX_JOINTS_PER_VERTEX	4 // Note: Keep this in sync with Engine/Renderer/RendererCore.h
#define HE_MAX_JOINTS_PER_MODEL		180 // Note: Keep this in sync with Engine/Renderer/RendererCore.h
...
#define SkeletonJoints_CB	SkeletonJoints_CB
// Samplers
