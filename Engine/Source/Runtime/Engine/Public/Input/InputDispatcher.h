...
using ActionPair		= std::pair<HHash, EInputEvent>;
...
private:
	...
	*/
	...
	void AddActionMappingInternal( HHash HintHash, DigitalInput MappedKey, const Char* HintName = NULL );
	void AddAxisMappingInternal( HHash HintHash, DigitalInput MappedKey, float Scale, const Char* HintName = NULL );
...
private:
	...
	std::map<HHash, std::vector<AxisCallback>> m_AxisCallbacks;
...
FORCEINLINE void FInputDispatcher::AddActionMappingInternal(HHash HintHash, DigitalInput MappedKey, const Char* HintName )
{
...
FORCEINLINE void FInputDispatcher::AddAxisMappingInternal(HHash HintHash, DigitalInput MappedKey, float Scale, const Char* HintName )
{
