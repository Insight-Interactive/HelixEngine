...
#define HE_ZERO_MEMORY( Data, Size ) ::memset( Data, 0, Size )
// Creates a buffer and zeros the memory.
#define HE_CREATE_BUFFER(Type, Name, ArrayElements) Type Name[ArrayElements]; HE_ZERO_MEMORY(Name, sizeof(Name))
