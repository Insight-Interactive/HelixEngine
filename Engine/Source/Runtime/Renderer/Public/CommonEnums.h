...
{
	CLT_Direct	= API_COMMAND_LIST_TYPE_DIRECT,
	CLT_Compute = API_COMMAND_LIST_TYPE_COMPUTE,
	CLT_Copy	= API_COMMAND_LIST_TYPE_COPY,
	CLT_Bundle	= API_COMMAND_LIST_TYPE_BUNDLE,
};
...
HE_DEFINE_ENUM_FLAG_OPERATORS(EResourceFlags);
...
HE_DEFINE_ENUM_FLAG_OPERATORS(ERootSignatureFlags);
...
{
	DT_Magenta2D			= 0,  // Useful for indicating missing textures
	DT_BlackOpaque2D		= 1,
	DT_BlackTransparent2D	= 2,
	DT_WhiteOpaque2D		= 3,
	DT_WhiteTransparent2D	= 4,
	DT_DefaultNormalMap		= 5,
	DT_BlackCubeMap			= 6,

	DT_NumDefaultTextures
};

// Indicies into GCommonResolutions for easier access.
enum EResolution
{
	kDefault	= 2,
	k720p		= 2,
...
enum ESwapchainBitDepth
{
	BD_8	= 0,
	BD_10	= 1,
	BD_16	= 2,

	kSwapchainBitDepthCount,
};
